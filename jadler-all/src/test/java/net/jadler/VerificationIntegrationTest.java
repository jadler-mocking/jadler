...
public class VerificationIntegrationTest {
    ...
    public void havingBody() throws IOException {
        ...
        verifyThatRequest()
                ...
                .havingBody(not(is(emptyOrNullString())))
                .receivedOnce();
    }
    ...
    public void havingEmptyHeader() throws IOException {
        ...
        verifyThatRequest()
                ...
                .havingHeader("empty")
                .havingHeader("empty", everyItem(is(emptyString())))
                .receivedOnce();
    }
    ...
    public void havingParameter_GET() throws IOException {
        ...
        verifyThatRequest()
                ...
                .havingParameter("p2", everyItem(not(is(emptyOrNullString()))))
     ...
     * are considered http parameters sources for such a http request.
     */
    @Test
    public void havingParameterPOST() throws IOException {
        ...
        verifyThatRequest()
                ...
                .havingParameter("p1", hasSize(1))
                .havingParameter("p1", everyItem(not(is(emptyOrNullString()))))
                .havingParameter("p1", contains("p1v1"))
    ...
    public void havingPath_root() throws IOException {
        ...
        verifyThatRequest()
                .havingPath(equalTo("/"))
                .havingPath(not(is(emptyOrNullString())))
                .receivedOnce();
    }
    ...
    /*
     * no request received negative scenario
     */
