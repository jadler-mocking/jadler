...
public class RequestTest {
    ...
    @Test
    public void getBodyAsBytesEmpty() {
        final Request req = Request.builder()
                .method("POST")
                .requestURI(create("http://localhost/"))
                .body(new byte[0])
    ...
    @Test
    public void getBodyAsStringEmpty() {
        final Request req = Request.builder()
                .method("POST")
                .requestURI(create("http://localhost/"))
                .body(new byte[0])
    ...
    @Test
    public void getBodyAsStringUTF8() {
        final Request req = Request.builder()
                .method("POST")
                .requestURI(create("http://localhost/"))
    ...
    @Test
    public void getBodyAsStringISO88592() {
        final Request req = Request.builder()
                .method("POST")
                .requestURI(create("http://localhost/"))
    ...
    @Test
    public void getBodyAsStringDefaultEncoding() {
        final Request req = Request.builder()
                .method("POST")
                .requestURI(create("http://localhost/"))
