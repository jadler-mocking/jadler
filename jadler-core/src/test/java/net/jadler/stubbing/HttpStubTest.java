...
public class HttpStubTest {
    ...
    public void matches() {
        final HttpStub rule = new HttpStub(
                Arrays.<Matcher<? super Request>>asList(anything(), not(anything()), anything()),
                DUMMY_RESPONSE_PRODUCER);
    ...
    public void describeMismatch() {
        ...
        @SuppressWarnings("unchecked") final Matcher<? super Request> m2 = mock(Matcher.class);
        ...
        @SuppressWarnings("unchecked") final Matcher<? super Request> m3 = mock(Matcher.class);
