...
public abstract class RequestMatcher<T> extends BaseMatcher<HttpServletRequest> {
    ...
    public void describeMismatch(final Object item, final Description description) {
        ...
        try {
            ...
            throw new JadlerException("An error ocurred while retrieving a value from the http request "
    ...
    public boolean matches(final Object o) {
        ...
        try {
            ...
            throw new JadlerException("An error ocurred while retrieving a value from the http request", e);
        }
